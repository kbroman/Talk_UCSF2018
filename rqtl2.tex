...
\\[2pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/uncc2017}{\tt \scriptsize
  \color{foreground} bit.ly/uncc2017}
}
...
\frame{
  ...
  \note{These are slides for a talk that I will give at the
    UNC-Charlotte on 22 Sep 2017.

    Source: {\tt https://github.com/kbroman/Talk\_UNCC2017} \\
    Slides: {\tt http://bit.ly/uncc2017}
}
} }
...
\center{
  ...
  {\color{vhilit} New} \\[12pt]
  University of Wisconsin--Madison \\[6pt]
  PhD in \href{https://bit.ly/MadBDS}{\color{subtitle} Biomedical Data Science}\\[36pt]
  \href{https://bit.ly/MadBDS}{\tt bit.ly/MadBDS} \\[18pt]
}
